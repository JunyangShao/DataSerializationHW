...
x_ax=[100,10000,1000000]
y_ax_complex=[compress_rate['complex'][100], compress_rate['complex'][10000], compress_rate['complex'][1000000]]
y_ax_plain=[compress_rate['plain'][100], compress_rate['plain'][10000], compress_rate['plain'][1000000]]
y_ax_moderate=[compress_rate['moderate'][100], compress_rate['moderate'][10000], compress_rate['moderate'][1000000]]
...
y_ax_plain=[compress_rate['plain'][100], compress_rate['plain'][10000], compress_rate['plain'][1000000]]
y_ax_moderate=[compress_rate['moderate'][100], compress_rate['moderate'][10000], compress_rate['moderate'][1000000]]
y_ax=[(y_ax_moderate[0]+y_ax_complex[0]+y_ax_plain[0])/3,(y_ax_moderate[1]+y_ax_complex[1]+y_ax_plain[1])/3,(y_ax_moderate[2]+y_ax_complex[2]+y_ax_plain[2])/3]
...
ax.set_xlabel('count of records')
x_ax=[100,10000,1000000]
y_ax_complex=[serialize_time['complex'][100], serialize_time['complex'][10000], serialize_time['complex'][1000000]]
y_ax_plain=[serialize_time['plain'][100], serialize_time['plain'][10000], serialize_time['plain'][1000000]]
y_ax_moderate=[serialize_time['moderate'][100], serialize_time['moderate'][10000], serialize_time['moderate'][1000000]]
ax.plot(x_ax, y_ax_complex, label='complex')  # Plot some data on the axes.
ax.plot(x_ax, y_ax_moderate, label='moderate')  # Plot some data on the axes.
ax.plot(x_ax, y_ax_plain, label='plain')  # Plot some data on the axes.
ax.legend()
...
ax.set_xlabel('count of records')
x_ax=[100,10000,1000000]
y_ax_complex=[deserialize_time['complex'][100], deserialize_time['complex'][10000], deserialize_time['complex'][1000000]]
y_ax_plain=[deserialize_time['plain'][100], deserialize_time['plain'][10000], deserialize_time['plain'][1000000]]
y_ax_moderate=[deserialize_time['moderate'][100], deserialize_time['moderate'][10000], deserialize_time['moderate'][1000000]]
ax.plot(x_ax, y_ax_complex, label='complex')  # Plot some data on the axes.
ax.plot(x_ax, y_ax_moderate, label='moderate')  # Plot some data on the axes.
ax.plot(x_ax, y_ax_plain, label='plain')  # Plot some data on the axes.
ax.legend()
